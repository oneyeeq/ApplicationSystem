...
![Заявка через Telegram-бота и обработка в админ-панели](assets/demo-bot-admin-panel.gif)

Клиент оставляет заявку в Telegram-боте — она сразу появляется в веб-панели администратора, где её принимают в работу и завершают.
...
![Прогон pytest](assets/demo-pytest.gif)
...
![Прогон vitest](assets/demo-frontend-tests.gif)
