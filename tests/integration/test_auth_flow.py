...
from app.security import generate_refresh_token, hash_password, hash_refresh_token
...
async def test_login_success(client):
    ...
    response = test_client.post("/auth/login/", json={"login": "admin", "password": "password123"})
...
async def test_login_wrong_password(client):
    ...
    response = test_client.post("/auth/login/", json={"login": "admin", "password": "password124"})
...
async def test_refresh_success(client):
    ...
    test_client.post("/auth/login/", json={"login": "admin", "password": "password123"})
...
async def test_logout_revokes_token(client):
    ...
    test_client.post("/auth/login/", json={"login": "admin", "password": "password123"})
    response_logout = test_client.post("/auth/logout/")
    response_refresh = test_client.post("/auth/refresh/")
